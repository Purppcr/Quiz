...
import {AcademyImage, ImageContainer, SignTextfield, SignupContainer, SignupPageContainer, Wrapper} from "./styled";
import {Button, Checkbox, FormControlLabel, Grid, Typography} from "@mui/material";
// @ts-ignore
import Hat from '../../assets/image/academyHat.png'
import {ContainedButton, LineButton, SimpleButton} from "../../buttons/styled";
        ...
        <Wrapper>
            <SignupPageContainer>
                <SignupContainer>
                    ...
                    <Grid container mb={5}>
                        <ContainedButton sx={{ padding: "10px 20px",}}>
                            Login
                        </ContainedButton>
                        <LineButton sx={{ padding: "20px 20px"}}>
                            Signup
                        </LineButton>
                    </Grid>
